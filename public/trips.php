...
<body>
    <main class="route-container">
        ...
        <div class="route-card">
            <div class="van-icon">
                <svg fill="#000000" width="80px" height="80px" viewBox="0 -33.95 122.88 122.88" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"  style="enable-background:new 0 0 122.88 54.98" xml:space="preserve">
