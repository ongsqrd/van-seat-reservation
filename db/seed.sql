...
INSERT INTO users (id, name, phone, password_hash, role) VALUES
  ...
  ( 3, 'Panupong Jaimethumde', '0924457781', '$2b$10$XrJHXqVrDD8eQqoFX2E6v.sBTN9c1iRP5NezG7jtojf7Ja5XpGbuO', 'passenger'),
  ...
  (14, 'Patchara Chainiyom',   '0930064471', '$2b$10$XrJHXqVrDD8eQqoFX2E6v.sBTN9c1iRP5NezG7jtojf7Ja5XpGbuO', 'driver'),
...
INSERT INTO trips (id, route_id, van_id, driver_id, trip_date, depart_time) VALUES
  ...
  ( 4, 1,  1, NULL, '2026-05-10', '11:00:00'),   
  ...
  (13, 3,  1,  3,   '2026-05-10', '12:00:00'),   
  (14, 3,  1,  3,   '2026-05-10', '13:30:00'),   
  (15, 3,  1, NULL, '2026-05-10', '15:00:00'),  
  (16, 3,  1, 11,   '2026-05-10', '16:30:00'),
  -- Route 4  Hua Mak -> Assumption U.
  (17, 4,  3, 11,   '2026-05-10', '08:00:00'),
  (18, 4,  3, NULL, '2026-05-10', '09:00:00'),   
  ...
  (24, 4,  5, NULL, '2026-05-10', '16:30:00'),   
...
INSERT INTO bookings
  ...
  ('F134WD24A', 13,  1, 4, 3, 'promptpay', 120, 'boarded'),  
  ('JW77XK2Q',  13,  2, 5, 1, 'card',       40, 'waiting'),  
  ('HQE34EF2',   5,  1, 3, 2, 'card',        80, 'waiting'), 
  ('A72KD91C',  26,  1, 3, 1, 'promptpay',   40, 'boarded'), 
  ('B65QP04E',  25,  1, 2, 4, 'card',       160, 'boarded'), 
  ('GT55RB2K',   1, 14, 1, 2, 'promptpay',   80, 'boarded'), 
  ('LM09WQ7C',   2,  4, 1, 1, 'card',        40, 'boarded'), 
  ('PN34KD8X',   3,  5, 1, 3, 'promptpay',  120, 'waiting'), 
  ('QR71ZC5V',  14,  6, 6, 2, 'card',        80, 'waiting'), 
  ('SD82YH3B',  14,  7, 5, 1, 'promptpay',   40, 'boarded'), 
  ('TF19MJ6N',  17,  8, 1, 4, 'card',       160, 'waiting'), 
  ('UH53PL0D',   5, 14, 3, 1, 'promptpay',   40, 'waiting'), 
  ('VJ64QK9M',  25,  4, 2, 2, 'card',        80, 'boarded'), 
  ('WK25RN1P',  27,  5, 1, 1, 'promptpay',   40, 'waiting'), 
  ('XL36SP7Q',  28,  6, 4, 3, 'card',       120, 'waiting'); 
